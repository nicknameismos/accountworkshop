                    ...
                    .end(function(arSaveErr, arSaveRes) {
                        ...
                        agent.get('/api/ars')
                            .end(function(arsGetErr, arsGetRes) {
                                ...
                                (ars[0].amount).should.match(500);
                                (ars[0].totalamount).should.match(535);
                                (ars[0].netamount).should.match(435);
                    ...
                    .end(function(arSaveErr, arSaveRes) {
                        ...
                        agent.get('/api/reportars')
                            .end(function(arsGetErr, arsGetRes) {
                                ...
                                (ars[0].debit[0].accname).should.match(ar.contact.name);
                                (ars[0].debit[0].amount).should.match(535);

                                (ars[0].credit[1].docref).should.match(ar.docno);
                                (ars[0].credit[1].docdate).should.match(ar.docdate);
                                (ars[0].credit[1].accname).should.match('ภาษีขาย');
                                (ars[0].credit[1].amount).should.match(35);
