...
describe('Contact CRUD tests', function() {
    ...
    it('should not be able to save an Contact if no govermentId is provided', function(done) {
        // Invalidate name field
        contact.govermentId = '';
        ...
        agent.post('/api/auth/signin')
            ...
            .end(function(signinErr, signinRes) {
                ...
                agent.post('/api/contacts')
                    ...
                    .end(function(contactSaveErr, contactSaveRes) {
                        // Set message assertion
                        (contactSaveRes.body.message).should.match('Please fill Contact govermentId');
